...
- Все колонки forecast-матрицы сортируются по ратушам по убыванию, итоговая
  строка показывает сумму уровней ратуш для каждой колонки, а название клана
  отделено от матрицы пустой строкой.
