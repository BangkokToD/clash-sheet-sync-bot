...
Если изменение нарушает один из этих пунктов, сначала нужно менять `SSOT.md`,
архитектурный документ и тесты.
...
Нормативные владельцы данных, приоритеты и инварианты:
...
Если изменение затрагивает runtime contract, обновить `SSOT.md` и связанную
документацию в том же коммите или отдельным соседним docs-коммитом.
