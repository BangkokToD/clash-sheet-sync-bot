...
from clash_sheet_sync_bot.setup.keyboards import (
    ...
    CALLBACK_CLAN_CONFIRM_PREFIX,
    CALLBACK_CLAN_MOVE_DOWN_PREFIX,
    CALLBACK_CLAN_MOVE_UP_PREFIX,
    CALLBACK_CLAN_REMOVE_PREFIX,
    CALLBACK_COLUMN_ADD_PREFIX,
    CALLBACK_COLUMN_DELETE_PREFIX,
    CALLBACK_COLUMN_MOVE_DOWN_PREFIX,
    CALLBACK_COLUMN_MOVE_UP_PREFIX,
    CALLBACK_COLUMN_RENAME_PREFIX,
    CALLBACK_COLUMN_RESTORE_PREFIX,
    CALLBACK_COLUMN_TOGGLE_PREFIX,
    CALLBACK_CONFIRM_UNLINK_SHEET_PREFIX,
    CALLBACK_CONNECT_GROUP,
    CALLBACK_CREATE_TRANSFER_PREFIX,
    CALLBACK_DIAGNOSE_SHEET_PREFIX,
    CALLBACK_FIX_SHEET_PREFIX,
    CALLBACK_HELP,
    CALLBACK_MY_GROUPS,
    CALLBACK_PRIVATE_START,
    CALLBACK_SETTINGS_PREFIX,
    CALLBACK_SETTINGS_SECTION_PREFIX,
    CALLBACK_UNLINK_SHEET_PREFIX,
    SETTINGS_SECTIONS,
    KnownGroupButton,
    check_sheet_access_keyboard,
    clans_section_keyboard,
    columns_section_keyboard,
    confirm_change_sheet_keyboard,
    confirm_clan_keyboard,
    confirm_unlink_sheet_keyboard,
    diagnostic_keyboard,
