...
DEFAULT_COLUMN_DEFINITIONS: Final[tuple[ColumnDefinition, ...]] = (
    ...
    ColumnDefinition("raids", "player_name", "Ник", True, "system", "string", 20),
    ColumnDefinition("raids", "player_tag", "Тег", True, "system", "string", 30),
    ...
    ColumnDefinition("raids", "coefficient", "Выполнение нормы", True, "system", "number", 60),
    ColumnDefinition(
        "raids",
