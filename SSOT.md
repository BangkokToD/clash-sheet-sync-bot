...
| `broadcasts` | Точный текст, custom emoji entities, статус и итоговые счётчики массовых рассылок |
...
- Migration 9 добавляет `broadcasts.entities_json`; старые рассылки
  получают пустой список entities без изменения текста.
